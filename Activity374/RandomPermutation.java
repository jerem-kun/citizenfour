...
public class RandomPermutation {
    ...
    public static void next(int length) {
      ...
      try {
        ...
        System.out.println("\nNon-scarmbled Horseys: " + java.util.Arrays.toString(g)); 
      ...
      System.out.println("\nScarmbled Horseys: " + java.util.Arrays.toString(seven) + "\n");
      ...
      for(int i = 0; i < limit; i++){
        System.out.println(seven[i*2] + " and " + seven[i*2+1] + " are partnered!");
      }

      if (length%2 != 0){
        System.out.println(seven[length-1] + " does not have a partner D: \n");
      }
